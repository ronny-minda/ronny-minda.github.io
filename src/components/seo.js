...
function Seo({ titulo }) {
  ...
  return (
    ...
    <Helmet>
    <title>{ titulo }</title>
    <meta name="google-site-verification" content="cChVu7MlRZTNnxm1MJi5q8EoC8-87P0Qbx2NUcHKJCk" />
    <meta charset="UTF-8"></meta>
    <meta name="description" content="Soy desrrolador de Software Frontend y Backend, conocimientos en api rest, responsive design, diseño moderno, trabajo en equipo con git y por ultimo validaciones del lado del servidor."></meta>
